...
function Hero() {
     ...
     return (
          <section id="home" className="relative flex-1 flex flex-col justify-center items-center text-center bg-gradient-to-r from-gray-900 via-gray-800 to-black py-40 w-full">
