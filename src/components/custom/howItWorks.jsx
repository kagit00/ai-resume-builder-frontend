...
function HowItWorks() {
  return (
    <section id="showcase" className="py-20 bg-gradient-to-r from-gray-900 via-gray-800 to-black">
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div className="bg-gray-700 p-6 md:p-8 rounded-3xl shadow-2xl transform hover:scale-105 transition-transform duration-300">
