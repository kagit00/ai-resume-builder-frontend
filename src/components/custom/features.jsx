...
function Features() {
     return (
          <section id="features" className="py-20 bg-gradient-to-r from-gray-900 via-gray-800 to-black">
               <div className="container mx-auto px-4 md:px-8 text-center">
                    <h3 className="text-4xl md:text-5xl lg:text-6xl mb-12 text-white">Key Features</h3>
