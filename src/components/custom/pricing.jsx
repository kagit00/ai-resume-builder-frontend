...
function Pricing() {
  return (
    <section id="pricing" className="py-20 bg-gradient-to-r from-gray-900 via-gray-800 to-black">
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-6">
            ...
            <div className="bg-gray-700 text-white p-6 md:p-8 rounded-3xl shadow-2xl w-full max-w-xs">
